...
export function VaultAI() {
  return (
    ...
    >
      ...
      {/* the flow */}
      <Reveal>
        <div className="transition duration-200 hover:-translate-y-1 hover:scale-[1.03] hover:border-accent hover:shadow-[0_16px_36px_-16px_rgba(79,70,229,0.45)] mb-10 flex flex-col items-stretch gap-3 rounded-xl border border-line bg-paper p-5 sm:flex-row sm:items-center">
          ...
          <FlowArrow />
          <div className="transition duration-200 hover:-translate-y-1 hover:scale-[1.03] hover:border-accent hover:shadow-[0_16px_36px_-16px_rgba(79,70,229,0.45)] flex flex-1 items-center justify-center rounded-lg border border-accent/30 bg-accent-soft px-4 py-3 text-center">
      ...
      <Reveal stagger className="grid gap-5 md:grid-cols-3">
        {AGENTS.map((a) => (
          <article key={a.name} className="transition duration-200 hover:-translate-y-1 hover:scale-[1.03] hover:border-accent hover:shadow-[0_16px_36px_-16px_rgba(79,70,229,0.45)] rounded-xl border border-line bg-paper p-6">
      ...
      <Reveal className="mt-10">
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
          {VAULTAI_STACK.map((s) => (
            <div key={s.layer} className="transition duration-200 hover:-translate-y-1 hover:scale-[1.03] hover:border-accent hover:shadow-[0_16px_36px_-16px_rgba(79,70,229,0.45)] rounded-lg border border-line bg-paper px-4 py-3">
...
function FlowStep({
  ...
  return (
    <div className="transition duration-200 hover:-translate-y-1 hover:scale-[1.03] hover:border-accent hover:shadow-[0_16px_36px_-16px_rgba(79,70,229,0.45)] flex flex-1 items-center gap-3 rounded-lg border border-line bg-paper-2 px-4 py-3">
...
function Highlight({ title, body }: { title: string; body: string }) {
  return (
    <div className="transition duration-200 hover:-translate-y-1 hover:scale-[1.03] hover:border-accent hover:shadow-[0_16px_36px_-16px_rgba(79,70,229,0.45)] rounded-xl border border-line bg-paper p-5">
